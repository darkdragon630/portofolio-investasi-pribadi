...
$total_keuntungan_global = $stmt_total_keuntungan->fetch()['total'];
...
$total_kerugian_global = $stmt_total_kerugian->fetch()['total'];
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="admin/kelola_kas.php" class="nav-item">
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="container">
                ...
                <div class="stats-grid-enhanced">
                    ...
                    <div class="stat-card stat-warning">
                        ...
                        <div class="stat-body">
                            ...
                            <div class="stat-value"><?= format_currency($saldo_kas) ?></div>
            ...
            <!-- Category Breakdown (NEW Enhanced) -->
